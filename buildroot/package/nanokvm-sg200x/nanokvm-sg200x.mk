...
# nanokvm-sg200x
#
# Downloads the NanoKVM skeleton (init scripts, kvm_system stubs,
# sensor configs) and assembles the full /kvmapp/ tree together with
# the binary and web assets built by nanokvm-server.
#
################################################################################

NANOKVM_SG200X_VERSION = 2.4.0
...
NANOKVM_SG200X_UPDATE_URL = https://cdn.sipeed.com/nanokvm
