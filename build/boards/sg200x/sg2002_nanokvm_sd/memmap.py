...
class MemoryMap:
    ...
    # NanoKVM: reduced from 105M to 75M — no local display pipeline,
    # frees ~30MB for user space (Go server, web UI, buffers).
    # =================
    ION_SIZE = 75 * SIZE_1M
    ...
    # NanoKVM: reduced from 8000K to 5632K — no local display
